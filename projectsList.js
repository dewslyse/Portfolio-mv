const projectsList = [
  ...
  },
  {
    ...
    liveURL: 'https://mv-trekker-api.herokuapp.com/',
  ...
  {
    title: 'Musings blog app',
    description: 'This blog app is a platform where users can create profiles and share articles with a community of readers. Users can filter articles based on categories of interest, making it easier to discover content that is relevant to them.',
    popupDescription: 'This blog app is a platform where users can create profiles and share articles with a community of readers. Users can filter articles based on categories of interest, making it easier to discover content that is relevant to them. With the ability to create and share articles, the app provides a space for users to express their thoughts, ideas, and experiences with others.',
    featuredImg: './images/musings.webp',
    popupImg: './images/musings-popup.webp',
    technologies: ['Ruby', 'Rails', 'Bootstrap', 'SCSS'],
    liveURL: 'https://musings-blog-app.herokuapp.com/',
    sourceURL: 'https://github.com/dewslyse/musings/',
    clientName: 'Personal',
    jobTitle: 'Freelance',
    jobYear: '2022',
  },
